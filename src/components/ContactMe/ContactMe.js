        ...
        <div>
            <div className="container my-24 px-6 mx-auto">
                            ...
                            <div className="max-w-[700px] mx-auto">
                                <form onSubmit={handleSubmit}>
                                    <div className="form-group mb-6">
                                        <input name='name' type="text" className="form-control block
               w-full
              px-3
              py-1.5
              text-base
              ...
              focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleInput7"
                                    ...
                                    <div className="form-group mb-6">
                                        <input name='email' type="email" className="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleInput8"
